...
/*
 * LOCAL MODIFICATIONS (must be propagated when upgrading version):
 *     Custom change to line 2790: changed "if (!sourceBindings)" to  "if (sourceBindings != null)"
 *     Custom change to line 2824: Added stack trace to error message.
 */
